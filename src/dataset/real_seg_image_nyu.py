...
class RealSegDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        tgt_image_name = seg_image_name.replace("/Label_Colored_40/", "/RGB/").replace(".png", ".jpg")
        ...
        if self.mode in ["default", "panoptic"]:
            ...
            ref_image_name = ref_seg_image_name.replace("/Label_Colored_40/", "/RGB/").replace(".png", ".jpg")
